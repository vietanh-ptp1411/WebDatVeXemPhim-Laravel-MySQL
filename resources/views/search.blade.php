...
<div class="container mt-4">
	<span class="pdc-hover" style="text-decoration: none;color: black"><h4 class="pdc">Kết quả tìm kiếm</h4></span>
	<div class="row">
		@foreach ($search_phim as $key => $phim)
		<div class="col-sm-3 col-md-3 col-xs-6">
			<div class="moviedangchieu">
				<img src="/anhda4/phim/{{$phim->image}}" width="100%" height="350px">
				<a href="{{url('phim',$phim->id)}}">
			...
			<div class="tieudephimdc mt-2">
				<h6 class="text-uppercase mb-0">{{$phim->tenphim}}</h6>
				<h6 class="text-uppercase en">{{$phim->tentienganh}}</h6>
			</div>
		</div>
		@endforeach
	</div>
